  ...
  return (
    <div className="bg-white rounded-xl shadow hover:shadow-lg transition p-4 relative">
      ...
      <div className="mt-4 grid grid-cols-2 gap-2">
        ...
        <button
          onClick={() => goToCheckout && goToCheckout(product)}
          className="w-full flex items-center justify-center gap-2 bg-amber-500 text-white py-2 rounded-lg hover:bg-amber-600 transition"
        >
          Buy Now
        </button>
      </div>
